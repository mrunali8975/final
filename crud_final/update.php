...
{  
    ...
    $id=$_GET['id'];
    $sql= "UPDATE `registration` SET id='$id' ,fname='$fname',lname='$lname' ,prn='$prn ',email_id='$email_id' WHERE id=$id ";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light text-white">
        <a class="navbar-brand" href="insert.php">Registration  Site </a>
    ...
    <div class="col-lg-6 m-auto bg-info ">
        <br>
        <h1 class="text-black text-center">Update Form </h1>
<form method="post"action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="PRN" name="prn" rows="3">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control" id="email" name="email_id" rows="3">
                        </div>
