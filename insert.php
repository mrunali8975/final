...
<body>
    ...
    <div class="container-fluid">
        <div id="page-wrap">
            ...
            <h1 class="headline display-4">Simple Quiz On Traffic Rule</h1>
<h3 class="text-center">It is neccessary t solve all question</h3>
    ...
    <div class="col-lg-6 m-auto ">
        <br>
        <h1 class="text-black text-center">FEEDBACK</h1>
